<form class="md:w-1/2 space-y-5" wire:submit.prevent='crearInterno'>
    
    <div>
       <x-label for="nro_historia" :value="__('Nro de Interno')" />
   ...
   <div>
    ...
    <div>
       <x-label for="ultimo_dia" :value="__('Fecha de Internación')" />
   ...
   <div>
       <x-label for="cuidados_intensivos" :value="__('Descripción del tratamiento o asistencia')" />

       <textarea 

       wire:model="cuidados_intensivos" 
       placeholder="Descripción del tratamiento, atención diaria"
